...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2031.3584913931145; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2391.2527216708104; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3136.0915375007626; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        perp.setDirection(DcMotorSimple.Direction.REVERSE); //reversed so increasing leftward
